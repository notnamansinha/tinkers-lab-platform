...
>
> **Companion docs:** [`ARCHITECTURE.md`](ARCHITECTURE.md) (system overview) · [`docs/`](docs/) (product specs) · [`src/types/index.ts`](src/types/index.ts) (single source of truth for all TypeScript types)
>

...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-3 py-1 text-[11px] font-bold uppercase tracking-wider w-fit whitespace-nowrap shrink-0 transition-all",
  {
    variants: {
      variant: {

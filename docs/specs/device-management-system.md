...
| August 12, 2026 | Complete Checkout History Query | `getAllCheckouts()` queries the collection group ordered by `createdAt` so admin history is not silently truncated |

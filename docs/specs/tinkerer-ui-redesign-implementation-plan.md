...
- `figjam-illustration-style.md` now matches the composite more closely after crosscheck, but implementation needs shared primitives so individual pages do not diverge.
...
1. `figjam-illustration-style.md`

...
>
>  **Security note:** this page documents variable *names* and placeholder formats only. **Real values live exclusively in local `.env.local` (git-ignored) and are never committed.** If you see a real-looking key in this repo, report it immediately.
